...
actor RemoteLog {
    ...
    private func openFileIfPossible() {
        ...
        if let appSupport = fm.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            candidates.append(appSupport.appendingPathComponent("ClaudeIsland").appendingPathComponent("Logs"))
        }

        candidates.append(fm.temporaryDirectory.appendingPathComponent("ClaudeIsland").appendingPathComponent("Logs"))
