...
struct HookInstaller {
    ...
    private static func updateSettings(at settingsURL: URL) {
        ...
        let command = "CLAUDE_ISLAND_SOCKET_PATH=\"\(sock)\" \(python) ~/.claude/hooks/claude-island-state.py"
    ...
    static func installOpenCodeAppStore(opencodeDir: URL) -> Bool {
        ...
        let pluginFile = pluginsDir.appendingPathComponent("claude-island.js")
        let socketFile = pluginsDir.appendingPathComponent("claude-island.socket")
        ...
        guard let bundled = Bundle.main.url(forResource: "claude-island-opencode", withExtension: "js") else {
            return false
        }
